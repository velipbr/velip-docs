...
> **Warning**
> Approval is asynchronous. A `200 OK` here only means the template was accepted for review. Use [`CheckTemplateStatus`](CheckTemplateStatus.md) to poll the actual status (`APPROVED`, `REJECTED`, `PENDING`).
