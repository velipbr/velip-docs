---
title: "Stream audio file"
description: "Download or stream a stored TTS audio or call recording."
api: "POST https://<base>/api/v2/PlayAudioFile.php"
---
